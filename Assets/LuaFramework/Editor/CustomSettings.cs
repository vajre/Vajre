...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(Shader)),
        _GT(typeof(Renderer)),
        _GT(typeof(WWW)).AddExtendType(typeof(UnityEngine.WWWAudioExtensions)),
        _GT(typeof(Screen)),
...
//        _GT(typeof(PanelManager)),
		...
		_GT(typeof(WidgetReference)),
		_GT(typeof(CrossPlatformInterface)),
		_GT(typeof(CrossPlatform)),
		_GT(typeof(IosCrossPlatform)),
		_GT(typeof(PlayerPrefs)),

        _GT(typeof(Gesture)),
        _GT(typeof(EasyTouch)),
        _GT(typeof(NewTCPClient)),
        _GT(typeof(TCPStatusType)),
        _GT(typeof(TCPRecvData)),
