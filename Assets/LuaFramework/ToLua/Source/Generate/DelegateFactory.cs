...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(SocketClient.MessageHandler), factory.SocketClient_MessageHandler);
		dict.Add(typeof(OnButtonPressed.PointerEvent), factory.OnButtonPressed_PointerEvent);
		...
		DelegateTraits<SocketClient.MessageHandler>.Init(factory.SocketClient_MessageHandler);
		DelegateTraits<OnButtonPressed.PointerEvent>.Init(factory.OnButtonPressed_PointerEvent);
		...
		TypeTraits<SocketClient.MessageHandler>.Init(factory.Check_SocketClient_MessageHandler);
		TypeTraits<OnButtonPressed.PointerEvent>.Init(factory.Check_OnButtonPressed_PointerEvent);
		...
		StackTraits<SocketClient.MessageHandler>.Push = factory.Push_SocketClient_MessageHandler;
		StackTraits<OnButtonPressed.PointerEvent>.Push = factory.Push_OnButtonPressed_PointerEvent;
	}
	...
	class SocketClient_MessageHandler_Event : LuaDelegate
	{
		public SocketClient_MessageHandler_Event(LuaFunction func) : base(func) { }
		public SocketClient_MessageHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public SocketClient.MessageHandler SocketClient_MessageHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			SocketClient.MessageHandler fn = delegate(int param0, LuaInterface.LuaByteBuffer param1) { };
			return fn;
		}

		if(!flag)
		{
			SocketClient_MessageHandler_Event target = new SocketClient_MessageHandler_Event(func);
			SocketClient.MessageHandler d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			SocketClient_MessageHandler_Event target = new SocketClient_MessageHandler_Event(func, self);
			SocketClient.MessageHandler d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_SocketClient_MessageHandler(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(SocketClient.MessageHandler), L, pos);
	}

	void Push_SocketClient_MessageHandler(IntPtr L, SocketClient.MessageHandler o)
	{
		ToLua.Push(L, o);
	}

	class OnButtonPressed_PointerEvent_Event : LuaDelegate
	{
		public OnButtonPressed_PointerEvent_Event(LuaFunction func) : base(func) { }
		public OnButtonPressed_PointerEvent_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public OnButtonPressed.PointerEvent OnButtonPressed_PointerEvent(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			OnButtonPressed.PointerEvent fn = delegate() { };
			return fn;
		}

		if(!flag)
		{
			OnButtonPressed_PointerEvent_Event target = new OnButtonPressed_PointerEvent_Event(func);
			OnButtonPressed.PointerEvent d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			OnButtonPressed_PointerEvent_Event target = new OnButtonPressed_PointerEvent_Event(func, self);
			OnButtonPressed.PointerEvent d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_OnButtonPressed_PointerEvent(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(OnButtonPressed.PointerEvent), L, pos);
	}

	void Push_OnButtonPressed_PointerEvent(IntPtr L, OnButtonPressed.PointerEvent o)
	{
		ToLua.Push(L, o);
	}
