...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		ScrollLocationHelperWrap.Register(L);
		WidgetReferenceWrap.Register(L);
		CrossPlatformInterfaceWrap.Register(L);
		CrossPlatformWrap.Register(L);
		IosCrossPlatformWrap.Register(L);
		NewTCPClientWrap.Register(L);
		TCPStatusTypeWrap.Register(L);
		...
		LuaFramework_LoadingManagerWrap.Register(L);
