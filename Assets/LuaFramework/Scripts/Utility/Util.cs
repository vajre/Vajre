...
namespace LuaFramework {
    public class Util
    {
        ...
        public static void CallLuaFunction(LuaFunction func)
        {
            if (func == null)
                return;
        ...
        public static void CallLuaFunction<T1>(LuaFunction func, T1 arg1)
        {
            if (func == null)
                return;
        ...
        public static void CallLuaFunction<T1, T2>(LuaFunction func, T1 arg1, T2 arg2)
        {
            if (func == null)
                return;
